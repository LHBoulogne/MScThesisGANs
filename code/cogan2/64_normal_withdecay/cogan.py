...
class CoGAN():
    ...
    def __init__(self, categories=0, z_len=100, g_d=128, d_d=128, imgch=3, loadfolder=None):
        ...
        self.G.weight_init(method='normal')
        self.D.weight_init(method='normal')
    ...
    def train(self,  mini_batch_size=128, k=1, nr_epochs=20, vis_step=10, vis_dim=6, savename=""):
        ...
        d_opt = optim.Adam(self.D.parameters(), lr=0.0002, betas=(0.5, 0.999), weight_decay=0.0005)
        g_opt = optim.Adam(self.G.parameters(), lr=0.0002, betas=(0.5, 0.999), weight_decay=0.0005)
...
cogan = CoGAN(0, imgch=1, g_d=64, d_d=5)
cogan.train()
